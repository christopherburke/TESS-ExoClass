...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector33'
    ...
    skyline_file = 'skyline_data_sector33_20200208.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector33_20200208.txt', dtype=['f8'])
