...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector41'
    ...
    skyline_file = 'skyline_data_sector41_20210917.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector41_20210917.txt', dtype=['f8'])
