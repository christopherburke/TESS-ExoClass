...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector31'
    ...
    skyline_file = 'skyline_data_sector31_20201218.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector31_20201218.txt', dtype=['f8'])
