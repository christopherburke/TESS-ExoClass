...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector14-55'
    ...
    skyline_file = 'skyline_data_sector-14-55_20220930.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector-14-55_20220930.txt', dtype=['f8'])
