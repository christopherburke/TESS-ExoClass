...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector50'
    ...
    skyline_file = 'skyline_data_sector-50_20220506.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector-50_20220506.txt', dtype=['f8'])
