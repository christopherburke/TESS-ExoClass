...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector42'
    ...
    skyline_file = 'skyline_data_sector42_20210930.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector42_20210930.txt', dtype=['f8'])
