...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector55'
    ...
    skyline_file = 'skyline_data_sector-55_20220919.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector-55_20220919.txt', dtype=['f8'])
