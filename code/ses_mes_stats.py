...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector25'
    ...
    skyline_file = 'skyline_data_sector25_20200717.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector25_20200717.txt', dtype=['f8'])
