...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector43'
    ...
    skyline_file = 'skyline_data_sector43_20211101.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector43_20211101.txt', dtype=['f8'])
