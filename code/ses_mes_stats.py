...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector48'
    ...
    skyline_file = 'skyline_data_sector48_20220314.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector48_20220314.txt', dtype=['f8'])
