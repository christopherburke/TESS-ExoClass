...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector49'
    ...
    skyline_file = 'skyline_data_sector-49_20220424.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector-49_20220424.txt', dtype=['f8'])
