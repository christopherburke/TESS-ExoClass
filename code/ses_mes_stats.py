...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector59'
    ...
    skyline_file = 'skyline_data_sector-59_20230204.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector-59_20230204.txt', dtype=['f8'])
