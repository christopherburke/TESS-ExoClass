...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector22'
    ...
    skyline_file = 'skyline_data_sector22_20200403.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector22_20200403.txt', dtype=['f8'])
