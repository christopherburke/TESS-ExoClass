...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector30'
    ...
    skyline_file = 'skyline_data_sector30_20201117.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector30_20201117.txt', dtype=['f8'])
