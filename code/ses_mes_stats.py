...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector1-39'
    ...
    skyline_file = 'skyline_data_sector1-39_20210827.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector1-39_20210827.txt', dtype=['f8'])
