...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector38'
    ...
    skyline_file = 'skyline_data_sector38_20210719.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector38_20210719.txt', dtype=['f8'])
