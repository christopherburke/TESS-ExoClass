...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector54'
    ...
    skyline_file = 'skyline_data_sector-54_20220907.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector-54_20220907.txt', dtype=['f8'])
