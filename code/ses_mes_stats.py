...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector26'
    ...
    skyline_file = 'skyline_data_sector26_20200730.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector26_20200730.txt', dtype=['f8'])
