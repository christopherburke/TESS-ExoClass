...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector40'
    ...
    skyline_file = 'skyline_data_sector40_20210826.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector40_20210826.txt', dtype=['f8'])
