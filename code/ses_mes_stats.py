...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector14-50'
    ...
    skyline_file = 'skyline_data_sector-14-50_20220630.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector-14-50_20220630.txt', dtype=['f8'])
