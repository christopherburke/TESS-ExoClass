...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector24'
    ...
    skyline_file = 'skyline_data_sector24_20200604.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector24_20200604.txt', dtype=['f8'])
