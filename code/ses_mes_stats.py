...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector47'
    ...
    skyline_file = 'skyline_data_sector47_20220207.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector47_20220207.txt', dtype=['f8'])
