...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector1-46'
    ...
    skyline_file = 'skyline_data_sector1-46_20220328.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector1-46_20220328.txt', dtype=['f8'])
