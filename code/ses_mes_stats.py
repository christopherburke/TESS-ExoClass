...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector51'
    ...
    skyline_file = 'skyline_data_sector-51_20220624.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector-51_20220624.txt', dtype=['f8'])
