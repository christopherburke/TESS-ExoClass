...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector57'
    ...
    skyline_file = 'skyline_data_sector-57_20221122.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector-57_20221122.txt', dtype=['f8'])
