...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector56'
    ...
    skyline_file = 'skyline_data_sector-56_20221023.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector-56_20221023.txt', dtype=['f8'])
