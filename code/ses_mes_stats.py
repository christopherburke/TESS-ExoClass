...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector46'
    ...
    skyline_file = 'skyline_data_sector46_20220118.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector46_20220118.txt', dtype=['f8'])
