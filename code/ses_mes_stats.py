...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector14-26'
    ...
    skyline_file = 'skyline_data_sector14-26_20200825.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector14-26_20200825.txt', dtype=['f8'])
