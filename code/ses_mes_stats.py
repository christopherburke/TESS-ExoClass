...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector53'
    ...
    skyline_file = 'skyline_data_sector-53_20220724.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector-53_20220724.txt', dtype=['f8'])
