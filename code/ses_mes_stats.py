...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector34'
    ...
    skyline_file = 'skyline_data_sector34_20210303.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector34_20210303.txt', dtype=['f8'])
