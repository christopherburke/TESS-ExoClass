...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector58'
    ...
    skyline_file = 'skyline_data_sector-58_20221227.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector-58_20221227.txt', dtype=['f8'])
