...
if __name__ == "__main__":
    ...
    dvDataDir = '/pdo/users/cjburke/spocvet/sector39'
    ...
    skyline_file = 'skyline_data_sector39_20210720.txt'
    if os.path.isfile(skyline_file):
        dataBlock = np.genfromtxt('skyline_data_sector39_20210720.txt', dtype=['f8'])
