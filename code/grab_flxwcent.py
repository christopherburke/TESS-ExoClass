...
if __name__ == '__main__':
    ...
    dirOutputs = '/pdo/users/cjburke/spocvet/sector14-50/'
    ...
    if SECTOR > 0:
        ...
        fileInputPrefixList.append('/pdo/spoc-data/sector-014-026+040-050/light-curve/tess2022085151738-s0050-')
        fileInputSuffixList = []
        for i in np.arange(1,SECTOR):
    ...
    #fileOut = 'spoc_pdcstats_sector-14-50_20220630.txt'
    #fom = open(fileOut, 'w')
