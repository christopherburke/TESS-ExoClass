...
#                           '/pdo/spoc-data/sector-026/light-curve/tess2020212050318-s0028-']
#
...
#  every sector
    ...
    dirOutputs = '/pdo/users/cjburke/spocvet/sector28/'
    RESAMP = 31  ###  USE AN ODD NUMBER ###
    SECTOR = 28# =-1 if multi-sector

    fileOut = 'spoc_pdcstats_sector28_20200925.txt'
    fom = open(fileOut, 'w')
