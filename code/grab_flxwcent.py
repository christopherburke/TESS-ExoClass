...
#                           '/pdo/spoc-data/sector-026/light-curve/tess2020351194500-s0033-']
#
...
#  every sector
    ...
    dirOutputs = '/pdo/users/cjburke/spocvet/sector33/'
    RESAMP = 31  ###  USE AN ODD NUMBER ###
    SECTOR = 33# =-1 if multi-sector

    fileOut = 'spoc_pdcstats_sector33_20200208.txt'
    fom = open(fileOut, 'w')
