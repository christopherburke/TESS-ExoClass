...
if __name__ == '__main__':
    ...
    if SECTOR > 0:
        ...
        fileInputPrefixList.append('/pdo/spoc-data/sector-057/light-curve/tess2022273165103-s0057-')
        fileInputSuffixList = []
        for i in np.arange(1,SECTOR):
            fileInputSuffixList.append('/foo{0:d}'.format(i))
        fileInputSuffixList.append('-0245-s_lc.fits.gz')
    else:
        print('Multi-Sector')
    ...
    #fileOut = 'spoc_pdcstats_sector-57_20221122.txt'
    #fom = open(fileOut, 'w')
