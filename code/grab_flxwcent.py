...
#                           '/pdo/spoc-data/sector-026/light-curve/tess2020294194027-s0031-']
#
...
#  every sector
    ...
    dirOutputs = '/pdo/users/cjburke/spocvet/sector31/'
    RESAMP = 31  ###  USE AN ODD NUMBER ###
    SECTOR = 31# =-1 if multi-sector

    fileOut = 'spoc_pdcstats_sector31_20201218.txt'
    fom = open(fileOut, 'w')
