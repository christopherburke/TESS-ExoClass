...
# 			  '/pdo/spoc-data/sector-046/light-curve/tess2022057073128-s0049-'
# ]
...
# Single sector block of file prefixes fill with fake values
    ...
    fileInputPrefixList.append('/pdo/spoc-data/sector-049/light-curve/tess2022057073128-s0049-')
    fileInputSuffixList = []
    for i in np.arange(1,SECTOR):
        fileInputSuffixList.append('/foo{0:d}'.format(i))
    fileInputSuffixList.append('-0221-s_lc.fits.gz')
    ...
    #                        '/pdo/spoc-data/sector-049/light-curve/tess2022057073128-s0049-']
    ...
    #fileOut = 'spoc_pdcstats_sector-49_20220424.txt'
    #fom = open(fileOut, 'w')
