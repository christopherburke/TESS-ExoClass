...
#                           '/pdo/spoc-data/sector-026/light-curve/tess2020324010417-s0032-']
#
...
#  every sector
    ...
    dirOutputs = '/pdo/users/cjburke/spocvet/sector32/'
    RESAMP = 31  ###  USE AN ODD NUMBER ###
    SECTOR = 32# =-1 if multi-sector

    fileOut = 'spoc_pdcstats_sector32_20200125.txt'
    fom = open(fileOut, 'w')
