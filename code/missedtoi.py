...
#    gtPer[idx] = 1000.0
    ...
    tceSeedInFile = 'sector31_20201218_tce.pkl'
...
#                                allpn, useper, useepc, usedur)
    ...
    # Read in Tier 1 list
    dataBlock=np.genfromtxt('spoc_ranking_Tier1_sector31_20201218.txt', \
                            dtype=['i4','i4','f8','i4'])
    t1Tic = dataBlock['f0']
    t1Pn = dataBlock['f1']
    t1rnk = dataBlock['f2']
    ...
    # Read in Tier 2 list
    dataBlock=np.genfromtxt('spoc_ranking_Tier2_sector31_20201218.txt', \
    ...
    # Read in Tier 3 list
    dataBlock=np.genfromtxt('spoc_ranking_Tier3_sector31_20201218.txt', \
