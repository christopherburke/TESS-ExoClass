...
#    gtPer[idx] = 1000.0
    ...
    tceSeedInFile = 'sector29_20201014_tce.pkl'
...
#                                allpn, useper, useepc, usedur)
    ...
    # Read in Tier 1 list
    dataBlock=np.genfromtxt('spoc_ranking_Tier1_sector29_20201014.txt', \
                            dtype=['i4','i4','f8','i4'])
    t1Tic = dataBlock['f0']
    t1Pn = dataBlock['f1']
    t1rnk = dataBlock['f2']
    ...
    # Read in Tier 2 list
    dataBlock=np.genfromtxt('spoc_ranking_Tier2_sector29_20201014.txt', \
    ...
    # Read in Tier 3 list
    dataBlock=np.genfromtxt('spoc_ranking_Tier3_sector29_20201014.txt', \
